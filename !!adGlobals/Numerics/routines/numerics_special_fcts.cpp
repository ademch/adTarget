...
// ) {
// 	return NR::betai(a,b,x);
// }

/// Normal distribution density Accurate
double normal_distribution(double x)
{
	const double inv_sqrt_2pi = 3.98942280401433e-1;
	return inv_sqrt_2pi * exp( - x*x * 0.5 );
}

/// normal cumulative distribution
double normal_cumulative_apx(double x)
{
	const double inv_sqrt2 = 7.07106781186547e-1;
	double norm_cum_from_infty = NR::erfcc(inv_sqrt2*x);
	return 1.0 - 0.5*norm_cum_from_infty;
} 

/// normal cumulative distribution
double normal_cumulative(double X)
{
	static const double NORM_ACCURATE_B_LOW = -45.0;
	static const double NORM_ACCURATE_B_HIGH = 15.0;
	static const double MATH_INV_SQRT2 = 7.07106781186547e-1;
	...
	static double THRESH= 0.46875;
	static double SQRPI=5.6418958354775628695*0.1;
...
double normal_cumulative_inv(double u)
{
