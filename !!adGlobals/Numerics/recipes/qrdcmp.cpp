...
/// The orthogonal matrix Q is represented as a product of n ? 1 Householder matrices Q_1 ... Q_{n-1}, where Qj = 1 - uj(x)uj/cj. 
/// The ith component of uj is zero for i = 1 ... j-1 while the nonzero components are returned in a[i][j] for i = j ... n. 
/// sing returns as true (1) if singularity is encountered during the decomposition, but the decomposition is still completed in this case; 
