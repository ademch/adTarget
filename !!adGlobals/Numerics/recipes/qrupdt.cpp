...
/// Given the QR decomposition of some n,n matrix, calculates the QR decomposition of the matrix Q.(R+u(x)v). 
/// The quantities are dimensioned as r[1..n][1..n], qt[1..n][1..n], u[1..n], and v[1..n]. 
/// Note that Q' is input and returned in qt.
