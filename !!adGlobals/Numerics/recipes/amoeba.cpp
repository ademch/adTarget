...
/// Also input is the vector y[1..ndim+1], whose components must be preinitialized to the values of funk evaluated at the ndim+1 vertices (rows) of p; 
/// and ftol the fractional convergence tolerance to be achieved in the function value (n.b.!). 
/// On output, p and y will have been reset to ndim+1 new points all within ftol of a minimum function value, 
